...
class User extends CPHPDatabaseRecordClass {
	...
	$sPanelTitle = Core::GetSetting('panel_title');
		...
		$uEmailContent = '<div align="center">
			NEON Activation<br><hr>
			<a href="http://yourdomain.com/activate.php?id='.$this->uActivationCode.'" target="_blank">Click Here To Activate Your Account</a>
			</div>';
		$uEmailHeaders  = "From: noreply@yourdomain.com\r\n";
